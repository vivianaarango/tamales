<div class="form-group row align-items-center" :class="{'has-danger': errors.has('date'), 'has-success': this.fields.date && this.fields.date.valid }">
    ...
    <div :class="'col-md-9 col-xl-7'">
        <input required type="date" class="form-control" :class="{'form-control-danger': errors.has('date'), 'form-control-success': this.fields.date && this.fields.date.valid}" id="date" name="date" placeholder="Fecha">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('lot'), 'has-success': this.fields.lot && this.fields.lot.valid }">
    ...
    <div :class="'col-md-9 col-xl-7'">
        <input required minlength="1" type="number" class="form-control" :class="{'form-control-danger': errors.has('lot'), 'form-control-success': this.fields.lot && this.fields.lot.valid}" id="lot" name="lot" placeholder="Lote">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('marmitas'), 'has-success': this.fields.marmitas && this.fields.marmitas.valid }">
    ...
    <div :class="'col-md-9 col-xl-7'">
        <input required minlength="1" type="number" class="form-control" :class="{'form-control-danger': errors.has('marmitas'), 'form-control-success': this.fields.marmitas && this.fields.marmitas.valid}" id="marmitas" name="marmitas" placeholder="Número de Marmitas">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('broken'), 'has-success': this.fields.broken && this.fields.broken.valid }">
    ...
    <div :class="'col-md-9 col-xl-7'">
        <input type="number" class="form-control" :class="{'form-control-danger': errors.has('broken'), 'form-control-success': this.fields.broken && this.fields.broken.valid}" id="broken" name="broken" placeholder="Tamales Rotos">
